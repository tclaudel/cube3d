...
/*   Updated: 2020/01/16 17:10:28 by tclaudel    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
void	ft_draw_lifebar(t_cub *c)
{
	...
	while (x < c->res[0] / 15)
	{
		...
		while (y > 0)
		{
			if ((x > c->res[0] / 80 && x < c->res[0] / 15 - c->res[0] / 80) && (y < (int)(c->res[1] * (double)c->life / 100.0)))
...
void	ft_draw_success(t_cub *c)
{
	...
	while (x < c->res[0])
	{
		...
		while (y > 0)
		{
			if ((x > c->res[0] - c->res[0] / 15  + c->res[0] / 80) && (y < (int)(c->res[1] * (double)c->collect / (double)(c->max_collect)) && x < c->res[0] - + c->res[0] / 80))
